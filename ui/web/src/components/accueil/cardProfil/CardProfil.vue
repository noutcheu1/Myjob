<template>
<section id="cardProfil">
  <div class="cardProfil">
    <br><div class="avatarMyjob" >
          <img src="./avatar.png">
     </div> <br>
     <div class="idUser space">
         <div class="nameUser space">Tchiaguia christophe</div>
         <div class="emailUser"> <span class="">tchiaguiachristophe25@gmail.com</span></div> <br>
     </div>
     ...
     <div class="settings space x">
         ...
         <div class="txt"><a href="#">Settings</a></div>
     </div>
...
<style src="./cardProfil.css">
</style>
<script src="./cardProfil.js">
</script>
